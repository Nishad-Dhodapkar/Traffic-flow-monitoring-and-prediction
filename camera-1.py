...
def predict_traffic(camera_num):
    ...
    return predicted_total_vehicles, predicted_hour, predicted_minute, predicted_category, r2
...
def index():
    if request.method == 'POST':
        ...
        if 'camera_num' in request.form:
            ...
            predicted_total_vehicles, predicted_hour, predicted_minute, predicted_category, r2 = predict_traffic(camera_num)
